...
export default function ChangelogID() {
  ...
  const updates = [
    {
        ...
        date: "13 Nov 2025",
        changes: [
          "Perbaikan bug minor pada sistem navigasi",
          "Peningkatan kecepatan pemuatan halaman",
          "Optimalisasi tampilan pada perangkat mobile",
          "Perbaikan fitur multibahasa",
        ],
    },
    {
      version: "v0.0.1",
      date: "12 Nov 2025",
      changes: [
        "Rilis awal platform Namura Property",
        "Penambahan listing properti & direktori agen",
        "Modul kalkulator KPR",
        "Halaman artikel & panduan properti",
      ],
    },
  ];
