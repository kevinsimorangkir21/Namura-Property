...
export default function NavbarID() {
  ...
  const navLinks = [
    ...
    { label: "Daftar Properti", href: "/id/daftar-properti" },
    { label: "Artikel", href: "/id/artikel" },
    { label: "Panduan", href: "/id/panduan" },
    { label: "Tentang Kami", href: "/id/tentang" },
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10 py-3 flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            <motion.img
              ...
              whileHover={{ rotate: 6 }}
            />
            <span className="font-semibold text-lg group-hover:text-[#00ccb0]">
              Namura Property
            </span>
          </Link>
          ...
          <button
            disabled
            className={`hidden md:inline-flex relative px-4 py-2 rounded-xl border text-sm font-semibold cursor-not-allowed 
            ${isDark
