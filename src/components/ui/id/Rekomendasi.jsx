      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-6 gap-4">
          <div>
            ...
            >
              Pilihan properti terbaik berdasarkan preferensi pencarianmu dan tren area terkait.
            </p>
          </div>

          <div className="flex items-center gap-3">
            <Link href="/id/daftar-properti">
              <button
                ...
                <div className="p-4">
                  ...
                  >
                    <span className="inline-flex items-center gap-1.5">
                      ...
                      {normalize(detail.kamarTidur)}
                    </span>
                    <span className="inline-flex items-center gap-1.5">
                      <Bath className="w-4 h-4" />{" "}
                      {normalize(detail.kamarMandi)}
                    </span>
                    <span className="inline-flex items-center gap-1.5">
                      <Ruler className="w-4 h-4" />{" "}
                      {normalize(detail.luasTanah)}
                    </span>
                  </div>

                  {p?.slug?.id && (
                    <Link href={`/id/daftar-properti/${p.slug.id}`}>
