...
export default function Contact() {
  ...
  const content = {
    id: {
      title: "Hubungi Kami",
      desc: "Silakan hubungi tim kami untuk bantuan, klarifikasi, atau dukungan terkait informasi listing, proses transaksi, dan kerja sama.",
      email: "Email Resmi",
      support: "Tim Support",
      office: "Kantor Operasional",
      mapSection: "Peta & Arah",
      mapDesc:
        "Lihat lokasi kantor kami di Google Maps dan atur rute terbaik menuju lokasi.",
      openMap: "Buka Google Maps",
      scheduleWA: "Atur Janji via WA",
    },
    en: {
      title: "Contact Us",
      desc: "Feel free to reach out to our team for assistance, clarification, or support related to listings, transactions, and partnerships.",
      email: "Official Email",
      support: "Support Team",
      office: "Operational Office",
      mapSection: "Map & Directions",
      mapDesc:
        "View our office location on Google Maps and plan your best route.",
      openMap: "Open Google Maps",
      scheduleWA: "Schedule via WhatsApp",
    },
  }[lang];
      ...
      >
        <div>
          <h3 className="flex items-center gap-2 text-lg font-semibold text-[#00ccb0] mb-2">
            <MapPin className="w-5 h-5" /> {content.mapSection}
          </h3>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            >
              {content.openMap} <ArrowRight className="w-4 h-4" />
            </a>

            <a
              href="https://wa.me/6282282512619?text=Halo%20Namura..."
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              {content.scheduleWA} <ArrowRight className="w-4 h-4" />
            </a>
          </div>
        </div>
